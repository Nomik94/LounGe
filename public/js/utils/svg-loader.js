const svgWrap = document.createElement('div'),
  ...
  <!-- SVG LOGO VIKINGER -->
  <svg style="display: none;">
    <symbol id="svg-logo-vikinger" viewBox="5 -10 95 10" preserveAspectRatio="xMinYMin meet">
      <circle cx="53.759" cy="19.742" r="12.242"></circle>
      <circle cx="20.238" cy="35.55" r="9.965"></circle>
      <path
        d="M47.633 92.602c-6.214-3.746-23.203-15.154-31.437-32.301-3.363-7.002-.865-9.157 2.386-12.903a9.922 9.922 0 0 0 7.059-.593 9.922 9.922 0 0 0 4.878-5.138c1.059-.042 2.039-.101 2.96-.102a26.797 26.797 0 0 0-.204 3.444c0 10.253 2.387 21.276 7.093 32.763a124.851 124.851 0 0 0 7.271 14.795l-.006.035z"
      ></path>
      <path
        d="M36.119 45.007c0-9.543 3.912-10.601 9.504-13.022a12.195 12.195 0 0 0 8.136 3.097c3.125 0 5.972-1.171 8.136-3.097 5.592 2.421 9.504 3.48 9.504 13.022 0 23.37-12.748 45.039-17.64 52.493-4.891-7.454-17.64-29.122-17.64-52.493z"
      ></path>
      <path
        d="M91.321 60.301c-8.233 17.148-25.222 28.555-31.437 32.301a.25.25 0 0 0-.006-.038c2.229-3.875 4.875-8.949 7.271-14.795 4.707-11.487 7.093-22.51 7.093-32.763 0-1.254-.069-2.396-.204-3.444.921 0 1.9.06 2.96.102a9.918 9.918 0 0 0 4.878 5.138 9.923 9.923 0 0 0 7.059.593c3.251 3.749 5.749 5.905 2.386 12.906z"
      ></path>
      <circle cx="87.28" cy="35.55" r="9.965"></circle>
    </symbol>
  </svg>
  <!-- /SVG LOGO VIKINGER -->
